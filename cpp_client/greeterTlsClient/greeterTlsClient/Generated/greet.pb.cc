...
const char descriptor_table_protodef_greet_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ld.HelloRequest\032\026.helloworld.HelloReplyB"
  "\021\252\002\016greeterWithTLSb\006proto3"
  ;
...
descriptor_table_greet_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_greet_2eproto);
  return descriptor_table_greet_2eproto.file_level_metadata[index];
}
